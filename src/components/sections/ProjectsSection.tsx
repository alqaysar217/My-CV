  ...
  <TooltipProvider>
    <Tooltip>
      <TooltipTrigger asChild>
        <div className="h-8 w-8 flex items-center justify-center bg-card/70 rounded-full border border-primary/20 backdrop-blur-sm text-primary transition-all duration-300 hover:bg-primary/20 hover:text-accent">
          {children}
        </div>
      </TooltipTrigger>
      <TooltipContent>
