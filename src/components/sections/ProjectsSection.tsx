  ...
  <TooltipProvider>
    <Tooltip>
      <TooltipTrigger asChild>
        <div className="h-8 w-8 flex items-center justify-center rounded-full bg-card/70 border border-primary/20 backdrop-blur-sm transition-all duration-300 hover:scale-110">
          {children}
        </div>
      </TooltipTrigger>
      <TooltipContent>
